...
class Flow_Control():
    ...
    def all_calls(self):
        ...
        # Avoid the error that occurs prior to uploading data
...
class Load_Data():
    ...
    def import_df(files):
        ...
        return uploaded_data_dict if uploaded_data_dict else None
            ...
            for filename, df in data_dict.items():
                ...
                for col in search_columns:
                    if col in df.columns:
                        ...
                        st.warning(f"{filename} is missing column: {col}")
