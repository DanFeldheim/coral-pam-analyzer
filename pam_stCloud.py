...
class Load_Data():
    ...
    def import_data(data_files):
        ...
        """
        Import a .csv PAM data file into a pandas DataFrame.
...
class Export():
    ...
    def arrange_by_genotype(self, max_dict):
        """
        Retrieves the genotype from max_dict.
        """
        ...
        # Loop through results dictionaries and match the max values with the genotype row
        for filename, results_dict in max_dict.items():
            ...
            for colname, val in results_dict.items():
                ...
                for substring in search_substrings:
                    ...
                    # Split the genotype label from the column name (genotype is between underscores)
                    if substring in colname:
                        
                        # Return the 3 parts of the column name, before, between, and after underscores
                        parse = colname.split("_")
                        ...
                        genotype = "_".join(parse[1:-1])
                        
                        # If the search_substring is already present in results file, then throw a warning
                        ...
                        # Add genotype, substring, and val to dict
                        final_results_dict[genotype][substring] = val
                        
                        # Add filename for future troubleshooting
    ...
    def add_to_output(self, final_results_dict, output_df):  
        """
        Matches the data in final_results_dict with the correct genotype row in the output file.
        """
        ...
        # Fill columns in the output file from final_results_dict
